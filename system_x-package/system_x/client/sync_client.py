...
class SyncSysXClient(BaseSysXClient):
    ...
    def __init__(self,
                 sysx_coordinator_adr: str,
                 sysx_coordinator_port: int,
                 kafka_url: str):
        super().__init__(sysx_coordinator_adr, sysx_coordinator_port)
    ...
    def submit_dataflow(self, stateflow_graph: StateflowGraph, external_modules: tuple = None):
        ...
        if self._sync_socket_to_coordinator is None:
            ...
            self._sync_socket_to_coordinator.connect(f'tcp://{self._sysx_coordinator_adr}'
                                                     f':{self._sysx_coordinator_port}')
