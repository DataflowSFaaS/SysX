...
from system_x.common.base_networking import BaseNetworking
from system_x.common.tcp_networking import NetworkingManager

from .system_x_future import SysXFuture, SysXAsyncFuture
...
class BaseSysXClient(ABC):

    def __init__(self,
                 system_x_coordinator_adr: str,
                 system_x_coordinator_port: int):
        self._system_x_coordinator_adr: str = system_x_coordinator_adr
        self._system_x_coordinator_port: int = system_x_coordinator_port
    ...
    def send_event(self,
                   ...
                   function: Type | str,
                   params: tuple = tuple(),
                   serializer: Serializer = Serializer.MSGPACK) -> SysXFuture | SysXAsyncFuture:
        raise NotImplementedError
