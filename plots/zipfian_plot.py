...
x = np.array(x_labels)
y_system_x_50 = [25, 26, 26, 26, 25, 26, 26, 26, 26, 26, 26, 26]
y_system_x_4000_50 = [25, 28, 34, 27, 27, 31, 28, 29, 31, 56, 150, 198]
...
y_system_x_99 = [44, 50, 45, 50, 44, 51, 45, 51, 47, 49, 54, 55]
y_system_x_4000_99 = [47, 64, 68, 50, 53, 97, 62, 64, 58, 300, 3355, 12812]
...
ax0.plot(x, y_system_x_50, "-o", color="#31688e", label="SysX 50p")
ax0.plot(x, y_system_x_99, "--", marker="o", color="#31688e", label="SysX 99p")
# ax0.set_xticklabels(x_labels)
ax0.plot(x, y_system_x_4000_50, "-o", color="#440154", label="SysX@4K 50p")
ax0.plot(x, y_system_x_4000_99, "--", marker="o", color="#440154", label="SysX@4K 99p")
...
ax1.plot(x, y_system_x_50, "-o", color="#31688e", label="SysX 50p")
ax1.plot(x, y_system_x_99, "--", marker="o", color="#31688e", label="SysX 99p")
ax1.plot(x, y_system_x_4000_50, "-o", color="#440154", label="SysX@4K 50p")
ax1.plot(x, y_system_x_4000_99, "--", marker="o", color="#440154", label="SysX@4K 99p")
