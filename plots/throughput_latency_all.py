...
y_sys_x_50 = np.array([15, 15, 14, None, 18, 18, 18, None, None, 18, None, 19, 19, 22, 22,
                      23, 24, 25, 25, 25, 26, 27, 29, 28, 32, 39, 43, 72, 119, 308, 502,
                      1382, 2842, 7514]).astype(np.double)
sys_x_50_mask = np.isfinite(y_sys_x_50)
...
y_sys_x_99 = np.array([20, 20, 20, None, 29, 29, 30, None, None, 32, None, 34, 35, 42, 41, 42, 43, 51, 48, 50, 57,
                      65, 97, 99, 108, 128, 152, 199, 280, 665, 1733, 1827, 3433, 11647]).astype(np.double)
sys_x_99_mask = np.isfinite(y_sys_x_99)
...
ax[0].plot(x[sys_x_50_mask], y_sys_x_50[sys_x_50_mask], "-o", color="#882255",
           linewidth=line_width, markersize=marker_size)
ax[0].plot(x[sys_x_99_mask], y_sys_x_99[sys_x_99_mask], "--", marker="o", color="#882255",
...
y_sys_x_50 = np.array([11, 9, 8, 9, 11, 12, 15, 29, None, None,
...
ax[1].plot(x[sys_x_50_mask], y_sys_x_50[sys_x_50_mask], "-o", color="#882255",
           linewidth=line_width, markersize=marker_size)
ax[1].plot(x[sys_x_99_mask], y_sys_x_99[sys_x_99_mask], "--", marker="o", color="#882255",
           linewidth=line_width, markersize=marker_size, markerfacecolor='none')
...
y_sys_x_50 = np.array([11, None, 10, 9, 10, 27, 27, 36, 27, 35, 42, 415, 624, 663, 59954]).astype(np.double)
sys_x_50_mask = np.isfinite(y_sys_x_50)
...
y_sys_x_99 = np.array([18, None, 18, 19, 20, 49, 50, 50, 45, 69, 92, 796, 987, 1083, 99216]).astype(np.double)
sys_x_99_mask = np.isfinite(y_sys_x_99)
...
ax[2].plot(x[sys_x_50_mask], y_sys_x_50[sys_x_50_mask], "-o", color="#882255",
           linewidth=line_width, markersize=marker_size)
ax[2].plot(x[sys_x_99_mask], y_sys_x_99[sys_x_99_mask], "--", marker="o", color="#882255",
           linewidth=line_width, markersize=marker_size, markerfacecolor='none')
...
# legend
leg1 = Line2D([0], [0], color=sys_x_color, linewidth=line_width, linestyle='-',
              label="sys_x 50p", marker="o", markersize=marker_size)
leg2 = Line2D([0], [0], color=sys_x_color, linewidth=line_width, linestyle='--',
              label="sys_x 99p", marker="o", markersize=marker_size, markerfacecolor='none')
