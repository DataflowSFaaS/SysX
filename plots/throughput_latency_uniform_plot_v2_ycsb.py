...
plt.plot(x[sys_x_50_mask], y_sys_x_50[sys_x_50_mask], "-o", color="#882255", label="sys_x 50p",
         linewidth=line_width, markersize=marker_size)
plt.plot(x[sys_x_99_mask], y_sys_x_99[sys_x_99_mask], "--", marker="o", color="#882255", label="sys_x 99p",
