...
y_system_x_99 = [34, 58, 53, 57, 55, 54, 53, 55, 58, 57, 58, 57]
...
plt.plot(x, y_system_x_50, "-o", color="#882255", label="SysX@2K 50p",
         linewidth=line_width, markersize=marker_size)
plt.plot(x, y_system_x_99, "--", marker="o", color="#882255", label="SysX@2K 99p",
