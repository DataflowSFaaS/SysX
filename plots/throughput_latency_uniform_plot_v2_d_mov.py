...
plt.plot(x[system_x_50_mask], y_system_x_50[system_x_50_mask], "-o", color="#882255", label=f"{sys_name} 50p",
         linewidth=line_width, markersize=marker_size)
plt.plot(x[system_x_99_mask], y_system_x_99[system_x_99_mask], "--", marker="o", color="#882255", label=f"{sys_name} 99p",
