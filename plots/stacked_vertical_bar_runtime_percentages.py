...
ax[0].set_yticks([])
ax[0].set_xticks([])
ax[0].title.set_text('SysX')
ax[0].set_axisbelow(True)

ax[0].text(0, 15.2, f"{y["SysX"][0]}%", color=mycolors[0])
ax[0].text(27, 15.2, f"{y["SysX"][1]}%", color=mycolors[1])
ax[0].text(90, 15.2, f"{y["SysX"][2]}%", color=mycolors[2])
