...
ax[0].set_yticks([])
ax[0].set_xticks([])
ax[0].title.set_text('sys_x')
ax[0].set_axisbelow(True)

ax[0].text(0, 15.2, f"{y["sys_x"][0]}%", color=mycolors[0])
ax[0].text(27, 15.2, f"{y["sys_x"][1]}%", color=mycolors[1])
ax[0].text(90, 15.2, f"{y["sys_x"][2]}%", color=mycolors[2])
