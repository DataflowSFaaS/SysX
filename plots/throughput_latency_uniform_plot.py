...
y_system_x_50 = [21, 28, 25, 26, 26, None, 24, 23, 22, 33, 50, 127, 639]
...
y_system_x_99 = [40, 48, 44, 50, 50, None, 44, 41, 41, 67, 281, 695, 1760]
...
ax0.plot(x, y_system_x_50, "-o", color="#31688e", label="system_x 50p")
ax0.plot(x, y_system_x_99, "--", marker="o", color="#31688e", label="system_x 99p")
...
ax1.plot(x, y_system_x_50, "-o", color="#31688e", label="system_x 50p")
ax1.plot(x, y_system_x_99, "--", marker="o", color="#31688e", label="system_x 99p")
