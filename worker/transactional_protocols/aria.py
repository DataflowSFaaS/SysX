...
from system_x.common.logging import logging
from system_x.common.message_types import MessageType
from system_x.common.tcp_networking import NetworkingManager
from system_x.common.operator import Operator
from system_x.common.serialization import Serializer, msgpack_serialization
from system_x.common.base_protocol import BaseTransactionalProtocol
from system_x.common.run_func_payload import RunFuncPayload, SequencedItem
from system_x.common.util.aio_task_scheduler import AIOTaskScheduler

from worker.egress.system_x_kafka_batch_egress import SysXKafkaBatchEgress
from worker.fault_tolerance.async_snapshots import AsyncSnapshotsMinio
from worker.ingress.system_x_kafka_ingress import SysXKafkaIngress
...
class AriaProtocol(BaseTransactionalProtocol):
    ...
    def __init__(self,
        ...
        self.ingress: SysXKafkaIngress = SysXKafkaIngress(networking=self.networking,
        ...
        self.egress: SysXKafkaBatchEgress = SysXKafkaBatchEgress(output_offsets, restart_after_recovery)
