...
from system_x.common.run_func_payload import RunFuncPayload

from worker.egress.system_x__kafka_egress import SysXKafkaEgress
from worker.fault_tolerance.async_snapshots import AsyncSnapshotsMinio
from worker.ingress.system_x_kafka_ingress_pure import SysXKafkaIngressPure
...
class UnsafeProtocol(BaseTransactionalProtocol):
    ...
    def __init__(self,
        ...
        self.egress: SysXKafkaEgress = SysXKafkaEgress()

        self.ingress: SysXKafkaIngressPure = SysXKafkaIngressPure(networking=self.networking,
                                                                  worker_id=worker_id,
