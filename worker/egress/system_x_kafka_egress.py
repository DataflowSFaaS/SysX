...
EGRESS_TOPIC_NAME: str = os.getenv('EGRESS_TOPIC_NAME', 'system_x-egress')
KAFKA_URL: str = os.getenv('KAFKA_URL', None)
EPOCH_INTERVAL_MS: int = int(os.getenv('EPOCH_INTERVAL_MS', 1))

# The BatchEgress always makes more sense!!! this could be deprecated
# (stays because the fault tolerance is more straightforward)


class SysXKafkaEgress(BaseEgress):
