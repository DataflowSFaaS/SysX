...
import uvloop
from system_x.common.serialization import msgpack_deserialization
...
async def consume():
    ...
    while not all_egress_topics_created(topics, egress_topic_names):
        ...
        print(f"Awaiting topics {egress_topic_names} to be created by the SysX coordinator, current topics: {topics}")
