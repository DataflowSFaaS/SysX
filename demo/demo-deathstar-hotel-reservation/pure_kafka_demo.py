...
def populate(system_x_client: SyncSysXClient):
    # populate the geo table
    system_x_client.send_event(operator=geo_operator,
                               key=1,
                               function='create',
                               params=(37.7867, 0))
    system_x_client.send_event(operator=geo_operator,
    ...
    # populate rate
    system_x_client.send_event(operator=rate_operator,
                               key=1,
                               function='create',
                               params=("RACK",
                                       "2015-04-09",
    ...
    system_x_client.send_event(operator=recommendation_operator,
                               key=1,
                               function='create',
    ...
    # populate hotels
    for i in range(100):
        system_x_client.send_event(operator=hotel_operator,
                                   key=i,
                                   function='create',
                                   params=(10,))
    ...
    # populate flights
    for i in range(100):
        system_x_client.send_event(operator=flight_operator,
                                   key=i,
                                   function='create',
                                   params=(10,))
