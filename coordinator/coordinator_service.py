...
from system_x.common.tcp_networking import NetworkingManager, MessagingMode
from system_x.common.protocols import Protocols
from system_x.common.serialization import Serializer
...
SNAPSHOT_BUCKET_NAME: str = os.getenv('SNAPSHOT_BUCKET_NAME', "system_x-snapshots")
    ...
    async def coordinator_controller(self, writer: StreamWriter, data, pool: concurrent.futures.ProcessPoolExecutor):
        ...
        match message_type:
            case MessageType.SendExecutionGraph:
                ...
                # Received execution graph from a system_x client
