...
from system_x.common.base_operator import BaseOperator
...
from system_x.common.stateflow_ingress import IngressTypes
from system_x.common.logging import logging
from system_x.common.exceptions import NotAStateflowGraph
...
class Coordinator(object):
    ...
    def create_kafka_ingress_topics(self, stateflow_graph: StateflowGraph):
        ...
        topics = [NewTopic(topic=operator.name, num_partitions=operator.n_partitions, replication_factor=1)
                  for operator in stateflow_graph.nodes.values()] + [NewTopic(topic='system_x-egress',
